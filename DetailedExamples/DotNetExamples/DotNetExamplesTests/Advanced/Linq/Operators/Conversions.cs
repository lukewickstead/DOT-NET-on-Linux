...
namespace Advanced.Linq.Tests
{
	...
	public class Conversion
	{
		...
		public void ToArray_LinqExt ()
		{
			...
			Assert.IsInstanceOfType (typeof(Array), samplePeople);
		...
		public void ToList_LinqExt ()
		{
			...
			Assert.AreEqual (7, samplePeople.Count ());
			Assert.IsInstanceOfType (typeof(List<Person>), samplePeople);
		...
		public void ToDictionary_LinqExt ()
		{
			...
			Assert.AreEqual (7, samplePeople.Count ());
			Assert.IsInstanceOfType (typeof(Dictionary<String,Person>), samplePeople);
